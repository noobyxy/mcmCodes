...
df5.to_excel('流水.xlsx', index=False)
df_in = pd.DataFrame(dict_in)
df_in.to_excel('出项c.xlsx',index=False)
df_out = pd.DataFrame(dict_out)
df_out.to_excel('进项c.xlsx',index=False)
failed_time_array = []
failed_money_array = []
